...
-- 교육 서비스 3개
INSERT INTO services (slug, title, subtitle, description, icon, color, page_content, curriculum, sort_order) VALUES
  ('immigrant', '이주민·유학생', '한국 정착의 첫걸음', '한국어 교육부터 문화 적응, 취업 준비까지. 이주민과 유학생이 한국 사회에 성공적으로 정착할 수 있도록 맞춤형 교육을 제공합니다.', 'globe', 'from-blue-500 to-cyan-400', '이주민과 유학생을 위한 체계적인 교육 프로그램을 운영합니다. 한국어 능력 향상부터 문화 이해, 취업 준비까지 종합적인 커리큘럼을 제공하여 성공적인 한국 정착을 돕습니다.', '1단계: 한국어 기초 교육|2단계: 문화 적응 프로그램|3단계: 취업 준비 워크숍|4단계: 사회 통합 실습', 0),
  ('senior', '중장년·시니어', '인생 2막의 시작', '풍부한 경험을 새로운 역량으로. 디지털 리터러시, 재취업 교육, 사회 참여 프로그램을 통해 활기찬 시니어 라이프를 설계합니다.', 'heart', 'from-emerald-500 to-teal-400', '중장년·시니어 세대를 위한 맞춤형 교육 프로그램입니다. 디지털 역량 강화, 재취업 지원, 사회 참여 활동 등 인생 2막을 위한 다양한 프로그램을 운영합니다.', '1단계: 디지털 리터러시 기초|2단계: 재취업 역량 개발|3단계: 사회 참여 프로그램|4단계: 자기 브랜딩', 1),
  ('career', '취업·직무 역량강화', '꿈을 현실로', '면접·스피치·자기소개서 코칭부터 커리어 설계까지. 현직 아나운서 출신 전문가의 실전 노하우로 취업 성공률을 높입니다.', 'rocket', 'from-violet-500 to-purple-400', '현직 아나운서이자 기업 면접관 출신 대표의 실전 노하우를 바탕으로 한 취업·직무 역량강화 프로그램입니다. 면접 준비, 스피치 훈련, 자기소개서 작성법, 커리어 설계까지 종합적으로 지원합니다.', '1단계: 자기분석 및 커리어 설계|2단계: 스피치·면접 집중 코칭|3단계: 자기소개서·이력서 클리닉|4단계: 실전 모의 면접', 2)
