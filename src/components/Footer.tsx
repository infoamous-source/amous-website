        ...
        <div className="py-16 grid md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex gap-3">
              {[
                ...
                { label: "Blog", icon: "M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-1 17.93c-3.95-.49-7-3.85-7-7.93 0-.62.08-1.21.21-1.79L9 15v1c0 1.1.9 2 2 2v1.93zm6.9-2.54c-.26-.81-1-1.39-1.9-1.39h-1v-3c0-.55-.45-1-1-1H8v-2h2c.55 0 1-.45 1-1V7h2c1.1 0 2-.9 2-2v-.41c2.93 1.19 5 4.06 5 7.41 0 2.08-.8 3.97-2.1 5.39z" },
              ].map((social) => (
                <a
                  key={social.label}
                  href="#"
          ...
          <div>
            ...
            <ul className="space-y-3">
              {["이주민/유학생 교육", "중장년/실버 교육", "청년 취업 코칭", "아동/청소년 교육", "기업 맞춤 교육"].map((link) => (
                <li key={link}>
          ...
          <div>
            ...
            <ul className="space-y-3">
              {["회사 소개", "블로그", "문의하기"].map((link) => (
                <li key={link}>
                  <a href={`#${link === "회사 소개" ? "about" : link === "블로그" ? "blog" : "contact"}`} className="text-sm text-gray-400 hover:text-white transition-colors">
                    {link}
                  </a>
                </li>
              ))}
